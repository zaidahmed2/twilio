      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-6 max-w-7xl mx-auto w-full space-y-6">
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
            <h1 className="text-2xl font-extrabold text-slate-900">Your Call History</h1>
            <p className="text-sm text-slate-500 mt-1">Review your recent outgoing browser voice call logs.</p>
          </div>

          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            {isLoading ? (
              <div className="p-12 text-center text-slate-500 text-sm">Loading call logs...</div>
            ) : calls.length === 0 ? (
              <div className="p-12 text-center text-slate-500 text-sm">No calls recorded yet.</div>
            ) : (
